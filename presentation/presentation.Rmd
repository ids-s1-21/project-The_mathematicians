...
Our research aims at investigating the attitudes if students toward mathematics.  
Specifically, we aims at answering the following questions:  
...
Are there any correlations between different groups of answers?
...
The result of an anonymous survey regarding "Beliefs about Mathematics" which was completed by students of the University of Edinburgh for the academic year 2019-2020 (Data set obtained from Dr. George Kinnear).  
  - 32 questions in total (One filter question)
